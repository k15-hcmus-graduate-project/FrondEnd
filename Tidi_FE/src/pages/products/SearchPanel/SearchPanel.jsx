...
class SearchPanel extends React.Component {
            ...
            elementContainer.push(
                <li key={i}>
                    <a
                        ...
                        className={brand.brand_name === this.state.filter.brand.brand_name ? "filter-item-selected" : undefined}
                    >
                        {brand.brand_name}
                    </a>
                </li>
    ...
    generateBranches() {
        ...
        // console.log(industries[0].branches);
                ...
                <div className="widget price mb-50">
                    ...
                    <div className="widget-desc">
                        <div className="d-flex">
                            <input
                                className={"form-control mr-2" + (this.state.filter.priceIsInvalid ? " is-invalid" : "")}
                                placeholder="From"
                                value={this.state.filter.priceFrom}
                                onChange={e => this.handleChangePrice("priceFrom", e.target.value)}
                            />
                            <input
                                className={"form-control" + (this.state.filter.priceIsInvalid ? " is-invalid" : "")}
                                placeholder="To"
